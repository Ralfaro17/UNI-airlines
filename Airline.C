...
int menu()
{
    ...
    textcolor(13);
    gotoxy(4, 6);
    cprintf("2 - Adquirir boletos");
    textcolor(9);
    gotoxy(5, 7);
    cprintf("3 - Cancelar boletos");
    textcolor(6);
    gotoxy(6, 8);
    cprintf("4 - Ver disponiblilidad");
    textcolor(2);
    gotoxy(7, 9);
    cprintf("5 - Ver boletos");
    textcolor(4);
    gotoxy(8, 10);
    cprintf("6 - Salir");
    gotoxy(3, 12);
...
int presentacion()
{
    ...
    textcolor(10);
    gotoxy(4, 5);
    cprintf("Hecho por: Roger Alfaro - Jessua Solis - Sharon Briceno");
    textcolor(10);
    gotoxy(4, 6);
    cprintf("Carnets: 2023-0599U | 2023-0851U | 2023-0616U");
    textcolor(13);
    gotoxy(4, 7);
    printf("Docente: Ing. Kevin Euclides Ramirez de Arellano Castrillo");
    textcolor(9);
    gotoxy(4, 8);
    printf("Grupo: 1M1 - CO");
    textcolor(15);
    gotoxy(4, 9);
    printf("Universidad Nacional de Ingenieria (UNI)");
...
int adquirir()
{
    ...
    for (i = 0; i < MAX_ASIENTOS; i++)
    {
        ...
        if (compra_exitosa == 1)
        {
            ...
            textcolor(10);
            gotoxy(4, 4);
            cprintf("NOMBRE = %s", comprador[i]);
            textcolor(10);
            gotoxy(4, 5);
            cprintf("CORREO = %s", correo[i]);
            textcolor(10);
            gotoxy(4, 6);
            cprintf("TELEFONO = %s", telefono[i]);
            textcolor(10);
            gotoxy(4, 7);
            cprintf("CANTIDAD DE BOLETOS = %d", boletos_comprados[i]);
            textcolor(10);
            gotoxy(4, 8);
            cprintf("ASIENTOS = ");
            ...
            for (j = 0; j < boletos_comprados[i]; j++)
            {
                printf("\033[0;33m");
                gotoxy(15 + (cont2 * 4), 8);
                cprintf(" %s ", posicion[comprados[i][j]]);
                printf("\033[0m");
                cont2++;
            }
...
int cancelar()
{
    ...
    if (boletos == boletos_comprados[id])
    {
        ...
        textcolor(10);
        gotoxy(4, 4);
        cprintf("NOMBRE = %s", comprador[id]);
        textcolor(10);
        gotoxy(4, 5);
        cprintf("CORREO = %s", correo[id]);
        textcolor(10);
        gotoxy(4, 6);
        cprintf("TELEFONO = %s", telefono[id]);
        textcolor(10);
        gotoxy(4, 7);
        cprintf("CANTIDAD DE BOLETOS = %d", boletos_comprados[id]);
        textcolor(10);
        gotoxy(4, 8);
        cprintf("ASIENTOS = ");
        for (i = 0; i < MAX_COMPRA_UNITARIA; i++)
        {
            ...
            if (comprados[id][i] > -1)
            {
                printf("\033[0;33m");
                gotoxy(15 + (cont2 * 4), 8);
                cprintf(" %s ", posicion[comprados[id][i]]);
                printf("\033[0m");
                cont2++;
            }
        }
